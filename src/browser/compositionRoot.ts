 ...
 * public core-owned interface (ARCH-002), reads the immutable initial
 * projection, and hands browser code no state mutator: the browser receives
 * only the read-only Simulation seam and the frozen projection (REQ-121).
 *
